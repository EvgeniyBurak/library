...
namespace Library
{
    public partial class FormSearch : Form
    {
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            CardBook = dataGridView2.Rows[0].Cells[0].Value + "\n" +
                       ...
                       dataGridView2.Rows[0].Cells[17].Value + " : " +
                       dataGridView2.Rows[0].Cells[16].Value + ", " +
                       dataGridView2.Rows[0].Cells[21].Value + ".- " +
                       dataGridView2.Rows[0].Cells[25].Value + ".-" +
                       "ISBN " + dataGridView2.Rows[0].Cells[36].Value + ".";
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
        {
            ...
            var price = new Price
            {
                ...
                COP = Convert.ToInt32((Convert.ToDouble(dataGridView2.Rows[0].Cells[38].Value) -
                                       Math.Truncate(Convert.ToDouble(dataGridView2.Rows[0].Cells[38].Value))) * 100)
            };
