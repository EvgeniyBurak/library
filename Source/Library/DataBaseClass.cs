            ...
            using (SqlConnection con = new SqlConnection(@"Data Source=ЖЕНЯ-ПК; Initial Catalog=Books;Integrated Security=True"))
            {
                try
                {
                    string sql = "UPDATE Book2 SET Author='" + Program.HEADER.Author +
                        ...
                        "', ParallelInformationAboutThePublication='" + Program.PUBLICATION.ParallelInformationAboutThePublication +
                        "', FirstInformationOnLiabilityRelatingPublication='" + Program.PUBLICATION.FirstInformationOnLiabilityRelatingPublication +
                        "', FurtherInformationOnLiabilityRelatingPublication='" + Program.PUBLICATION.FurtherInformationOnLiabilityRelatingPublication +
                        "', AdditionalInformationAboutPublication='" + Program.PUBLICATION.AdditionalInformationAboutPublication +
                        "', FirstInformationOnLiabilityRelatingToAdditionalInformationPublication='" + Program.PUBLICATION.FirstInformationOnLiabilityRelatingToAdditionalInformationPublication +
                        "', FurtherInformationOnLiabilityRelatingToAdditionalInformationPublication='" + Program.PUBLICATION.FurtherInformationOnLiabilityRelatingToAdditionalInformationPublication +
                        ...
                        "', SpecificDesignationMaterialAndVolume='" + Program.PHCHARACTERISTICS.SpecificDesignationMaterialAndVolume +
                        "', OtherInformationAboutPhysicalCharacteristics='" + Program.PHCHARACTERISTICS.OtherInformationAboutPhysicalCharacteristics +
                        "', Dimensions='" + Program.PHCHARACTERISTICS.Dimensions +
                        "', InformationAccompanyingMaterial='" + Program.PHCHARACTERISTICS.InformationAccompanyingMaterial +

                        "', TitleSeries='" + Program.SERIES.TitleSeries +
                        "', ParallelTitleSeries='" + Program.SERIES.ParallelTitleSeries +
                        "', InformationPertainingTitleSeries='" + Program.SERIES.InformationPertainingTitleSeries +
                        "', FirstInformationAboutLiabilityRelatedSeries='" + Program.SERIES.FirstInformationAboutLiabilityRelatedSeries +
                        "', SubsequentLiabilityInformationRelatingSeries='" + Program.SERIES.SubsequentLiabilityInformationRelatingSeries +
