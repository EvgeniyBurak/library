...
namespace Library {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BooksRow AddBooksRow(int id_book, string name, string ISBN, string author) {
...
namespace Library.LibraryDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([id_book] = @Original_id_book))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([id_book], [name], [ISBN], [author]) VALUES (@id_book," +
                " @name, @ISBN, @author);\r\nSELECT id_book, name, ISBN, author FROM Books WHERE (i" +
                "d_book = @id_book)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [id_book] = @id_book, [name] = @name, [ISBN] = @ISBN, [a" +
                "uthor] = @author WHERE (([id_book] = @Original_id_book));\r\nSELECT id_book, name," +
                " ISBN, author FROM Books WHERE (id_book = @id_book)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_book, name, ISBN, author FROM dbo.Books";
        ...
        public virtual int Insert(int id_book, string name, string ISBN, string author) {
        ...
        public virtual int Update(int id_book, string name, string ISBN, string author, int Original_id_book) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string ISBN, string author, int Original_id_book) {
            return this.Update(Original_id_book, name, ISBN, author, Original_id_book);
        }
    }
